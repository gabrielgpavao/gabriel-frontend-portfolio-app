			...
			<StyledContainer>
				...
				<div className='flexLayout'>
					<div>
						...
						<p className='shorterParagraph'>Me envie um email preenchendo as informações ao lado ou envie diretamente para este endereço: <a href='mailto:gabpavao@outlook.com'>gabpavao@outlook.com</a></p>
